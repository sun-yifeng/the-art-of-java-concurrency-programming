 ...
 **/
public class InterruptionInJava4 implements Runnable {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // 新建线程
        Thread testThread = new Thread(new InterruptionInJava4(), "InterruptionInJava4");
        // start thread
        testThread.start();
        // main线程休眠1秒
        Thread.sleep(1000);
